      ...
      <div className="d-flex flex-grow-1">
        ...
        >
          <ul className="nav flex-column p-3 align-items-center gap-2">
            ...
            <li className="nav-item w-100">
              <a className="nav-link text-dark fw-semibold d-flex flex-column align-items-center py-3 rounded-4 hover-shadow" href="#">
            ...
            <li className="nav-item w-100">
              <a className="nav-link text-dark fw-semibold d-flex flex-column align-items-center py-3 rounded-4" href="#">
            ...
            <li className="nav-item w-100">
              <a className="nav-link text-dark fw-semibold d-flex flex-column align-items-center py-3 rounded-4" href="#">
                <i className="bi bi-calendar-check fs-4 mb-1"></i>
                <span>Planner</span>
              </a>
            </li>
          </ul>
