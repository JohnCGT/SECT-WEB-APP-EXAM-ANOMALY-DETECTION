      ...
      <div className="bg-white border-bottom shadow-sm px-4 pt-4 pb-0">
        ...
        <nav aria-label="breadcrumb" className="mb-2">
          <ol className="breadcrumb mb-0 small">
            <li className="breadcrumb-item"><Link to="/instructor" className="text-decoration-none text-muted">Dashboard</Link></li>
            <li className="breadcrumb-item"><Link to="/instructor/exams" className="text-decoration-none text-muted">Exams</Link></li>
            <li className="breadcrumb-item active fw-semibold">{course.code}</li>
          </ol>
        </nav>

        {/* Course title + quick actions */}
        <div className="d-flex justify-content-between align-items-start mb-3 flex-wrap gap-3">
          <div>
            <div className="d-flex align-items-center gap-3 mb-1">
              ...
              <div>
                <h3 className="mb-0 fw-bold">{course.code} — {course.name}</h3>
          ...
          <div className="d-flex gap-2">
            ...
            <Link to="/instructor/exams" state={{ openCreateExam: true }} className="btn btn-primary">
        ...
        <ul className="nav nav-tabs border-0 mb-0">
          {[
            ...
            <li key={key} className="nav-item">
              <button
                className={`nav-link pb-3 ${activeTab === key ? 'active fw-semibold border-bottom border-primary border-3' : 'text-muted'}`}
        ...
        {activeTab === 'overview' && (
          <div className="row g-4">
            ...
            <div className="col-12">
              <div className="row g-3">
                {[
                  ...
                  { icon: 'bi-people',             color: 'success',   label: 'Enrolled Students',value: students.length          },
            ...
            <div className="col-md-7">
              <div className="card shadow-sm border-0 h-100">
                <div className="card-header bg-white d-flex justify-content-between align-items-center">
                  <h6 className="mb-0 fw-semibold"><i className="bi bi-file-earmark-text me-2 text-primary"></i>Recent Exams</h6>
                  <button className="btn btn-sm btn-link text-primary p-0" onClick={() => setActiveTab('exams')}>View all →</button>
                </div>
                  ...
                  {exams.length === 0 ? (
                    ...
                    <div className="table-responsive">
                      <table className="table table-hover mb-0">
                        <thead className="table-light"><tr><th>TITLE</th><th>TYPE</th><th>DATE</th><th>STATUS</th></tr></thead>
                        <tbody>
            ...
            <div className="col-md-5">
              <div className="card shadow-sm border-0 h-100">
                <div className="card-header bg-white d-flex justify-content-between align-items-center">
                  <h6 className="mb-0 fw-semibold"><i className="bi bi-people me-2 text-success"></i>Enrolled Students</h6>
                  <div className="d-flex gap-2">
                    <button className="btn btn-sm btn-success" onClick={() => setShowAddModal(true)}>
                      <i className="bi bi-person-plus me-1"></i>Add
                    </button>
                    <button className="btn btn-sm btn-link text-primary p-0" onClick={() => setActiveTab('students')}>View all →</button>
                  </div>
                </div>
                <div className="card-body p-0">
                  {students.length === 0 ? (
              ...
              {exams.length > 0 && (
                <div className="d-flex gap-2 mt-2 flex-wrap align-items-center">
                  <div className="input-group" style={{ maxWidth: 280 }}>
                    ...
                    {examSearch && (
                      <button className="btn btn-outline-secondary" onClick={() => setExamSearch('')}><i className="bi bi-x"></i></button>
                    )}
                  </div>
                ...
                <div className="table-responsive">
                  <table className="table table-hover mb-0">
                    <thead className="table-light">
                      <tr>
                        <th>EXAM NAME</th><th>TYPE</th><th>START TIME</th>
              ...
              {students.length > 0 && (
                <div className="mt-2">
                  <div className="input-group" style={{ maxWidth: 320 }}>
                    ...
                    {studentSearch && (
                      <button className="btn btn-outline-secondary" onClick={() => setStudentSearch('')}><i className="bi bi-x"></i></button>
                    )}
                  </div>
                </div>
              )}
          ...
          <div className="modal-header border-0 pb-0">
            <div>
              ...
              <div className="d-flex align-items-center gap-2 mt-1">
                <i className="bi bi-folder2 text-primary small"></i>
